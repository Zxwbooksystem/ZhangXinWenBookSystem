...
<div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2>添加图书编号</h2>
                <div class="block ">
                    <form id="form" action="<%=path %><%=path %>?ac=tsxxadd&tsid=<%=tsid %>" method="post">
                    <table class="form">
                        <tr>
                            <td class="col1">
                                <label>图书编号</label>
                            ...
                            <td class="col2">
                                <input type="text" id="" name="bianhao" value="<%=Info.getAutoNo() %>" readonly="readonly" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        <tr>
