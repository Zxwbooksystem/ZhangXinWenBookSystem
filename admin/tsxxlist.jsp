...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
	 ...
	 String sql = "select * from tushuxx where 1=1 and delstatus=0 and gsstatus='' and tsid="+tsid;
	 String url = "/tushupiaoliusys/admin/tsxxlist.jsp?1=1";
                ...
                <div class="block">
					...
					<tbody>
					 <%
					   ...
					   if(did!=null){
						   dao.commOper("update tushuxx set delstatus=1 where id="+did);
					   ...
					   ArrayList<HashMap> list=(ArrayList<HashMap>)bean.getCollection();
						...
						<tr class="odd gradeX" align="center">
							...
							<td align="center">
							<%if(map.get("status").equals("待借")){%>
							<a href="<%=path %><%=path %>?ac=tsxx&id=<%=map.get("id") %>&tsid=<%=tsid %>" >删除</a>
							<%} %>
							</td>
						</tr>
						<%} %>
