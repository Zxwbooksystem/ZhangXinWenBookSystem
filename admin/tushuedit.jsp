...
HashMap map = dao.select("select * from tushu where id="+id).get(0);
...
<div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2>编辑图书</h2>
                <div class="block ">
                    <form id="form" action="<%=path %><%=path %>?ac=tushuedit&id=<%=id %>" method="post">
                    ...
                    <tr>
                            ...
                            <td class="col2">
                               <img alt="" src="/tushupiaoliusys/upfile/<%=map.get("filename") %>" id="imgfilename" style="width: 100px;height: 100px;">
							<input  name="filename" value="<%=map.get("filename") %>" type='hidden' class="form-control" placeholder="点击按钮上传图片"  required    id='url'  size='40'  /><br>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input type="text" id="name" value="<%=map.get("name") %>" name="name" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input type="text" id="zouzhe" value="<%=map.get("zouzhe") %>" name="zouzhe" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input type="text" id="cbs" name="cbs" value="<%=map.get("cbs") %>" class="input-xlarge span12" required>
                            </td>
                        </tr>
                            ...
                            <td class="col2">
                                <input type="text" id="shujia" name="shujia" value="<%=map.get("shujia") %>" class="input-xlarge span12" required>
                            </td>
                        </tr>
                            ...
                            <td class="col2">
                                <input type="text" id="dinjia" name="dinjia" value="<%=map.get("dinjia") %>" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">
							    ...
							    <%ArrayList<HashMap> sprotypelist = (ArrayList<HashMap>)dao.select("select *  from protype where  fatherid='"+map.get("fid")+"' ");
								    		...
								    		<option value="<%=sprotype.get("id") %>" <%if(map.get("sid").equals(sprotype.get("id").toString())){out.print("selected==selected");} %>><%=sprotype.get("typename") %></option>
								    		<%} %>
							</select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <textarea id="editor_id" id="note" name="note" style="width:700px;height:200px;" ><%=map.get("note") %></textarea>
                            </td>
                        </tr>
                        <tr>
