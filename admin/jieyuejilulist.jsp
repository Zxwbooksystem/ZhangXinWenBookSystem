...
<%	 CommDAO dao = new CommDAO(); 
     String sql = "select * from tushujy where 1=1 and delstatus='0' and hsstatus='已还'";
	 String url = "/tushupiaoliusys/admin/jieyuejilulist.jsp?1=1";
                    ...
                    <thead>
						<tr>
							<th colspan="9" align="left">
								<form action="/tushupiaoliusys/admin/jieyuejilulist.jsp?f=f" method="post" class="form-inline" style="padding-bottom: 10px;">
				         ...
				         <td><%=map.get("cbs") %></td>
				          ...
				          <td><%=fprotype.get("typename") %> （<%=sprotype.get("typename") %>）</td>
						   <td><%=jymap.get("hsstatus") %> </td>
							...
							<td align="center">
							<a href="<%=path %>/admin/jieyuejilulist.jsp?did=<%=jymap.get("id") %>" >删除记录</a>
