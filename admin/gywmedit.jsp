...
afterBlur : function(){ this.sync(); }  //Kindeditor下获取文本框信息
    ...
    CommDAO dao = new CommDAO();
	 HashMap map = dao.select("select * from gywm where id=1").get(0);
%>
  <body>
<div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2>关于我们</h2>
                <div class="block ">
                    <form id="form" action="<%=path %><%=path %>?ac=gywmedit&id=<%=map.get("id") %>" method="post">
                    <table class="form">
                        <tr>
                            <td class="col1">
                                <label>名称</label>
                            ...
                            <td class="col2">
                                <input type="text" value="<%=map.get("name") %>" id="name" name="name" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
